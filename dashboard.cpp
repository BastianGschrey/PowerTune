...
void DashBoard::setEXAnalogInput0(const qreal &EXAnalogInput0)
{
    ...
    qreal Rtotal = (((1430*1000)/2430)*(5 - EXAnalogInput0))/EXAnalogInput0;
    ResistanceEXAN0 = Rtotal - ((1430*1000)/(1430+1000));
...
void DashBoard::setEXAnalogInput2(const qreal &EXAnalogInput2)
{
    ...
    qreal Rtotal = (((1430*1000)/2430)*(5 - EXAnalogInput2))/EXAnalogInput2;
    ResistanceEXAN2 = Rtotal - ((1430*1000)/(1430+1000));
