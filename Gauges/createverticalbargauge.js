...
function createVerticalGauge(setWidth,setHeight,setX,setY,setMaxValue,setID,SetValueObject,SetValueProperty) {
    component = Qt.createComponent("verticalbargauge.qml");
    if (component.status == Component.Ready)
        finishCreation(setWidth,setHeight,setX,setY,setMaxValue,setID,SetValueObject,SetValueProperty);
    else
        component.statusChanged.connect(finishCreation);
}

function finishCreation(setWidth,setHeight,setX,setY,setMaxValue,setID,SetValueObject,SetValueProperty) {
