...
*/
                        ...
                        Text  { text: "V 1.88f ";color: "white";font.pixelSize: windowbackround.width / 55} //spacer
        ...
        Rectangle{
            ...
            Grid {
                ...
                ComboBox {
                    ...
                    height: daemons.height /15
                    font.pixelSize: daemons.width / 55
                    model: [ "None","HaltechV2","Link Generic Dash","Microtech","Consult","M800 Set1","OBD2","Hondata","Adaptronic CAN"]
                    delegate: ItemDelegate {
